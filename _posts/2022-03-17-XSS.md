...
<script>alert(hello! I am Ali! Nice to meet u ^ ^)</script>
...
%3cscript%3ealert(hello! I am Ali! Nice to meet u ^ ^)%3c/script%3e
...
```html
</body\>\</textarea\>\</td\>\<svg\>\<script\>alert&#40hello! I am Ali! Nice to meet u ^ ^&#41\</script\>
```
